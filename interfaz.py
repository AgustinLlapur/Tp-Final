...
class VentanaJuego:
    ...
    def plot_vehiculos_usuario(self, vehiculo):
        ...
        for i in range(vehiculo.cant):
            while True:
                try:
                    x, y, z, numero = self.mapa.obtener_coordenadas_usuario(vehiculo.name, i)
                except ValueError:
                ...
                if self.mapa.verificar_limites(x, y, z, vehiculo.largo, vehiculo.ancho, vehiculo.alto, es_avion):
                    if not self.mapa.verificar_colision(x, y, z, vehiculo.largo, vehiculo.ancho, vehiculo.alto, es_avion):
                        ...
                        if es_avion:
                            ...
                            obj.Avion.posicionar_avion(x, y, z, self.voxelarray)

                        else:
                            obj.Vehiculo.posicionar(x, y, z, self.voxelarray)
...
class InicioBatallaNaval:
    ...
    def iniciar_juego(self) -> None:
        ...
        # Llamar a la función main del juego y pasar la ventana del juego

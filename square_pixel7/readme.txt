...
True Type Font: Square Pixel-7 version 1.0


EULA
-==-
The font Square Pixel-7 is freeware for home using.


DESCRIPTION
-=========-
Original square pixel font. Native size is 15 points. Cyrillic code page is supported.

Files in square_pixel-7.zip:
       	readme.txt     			this file.
        square_pixel-7.ttf    		regular true type font;
	square_pixel-7.fon   		font in Windows OS "FON";
	square_pixel-7_screen.png	preview image.
